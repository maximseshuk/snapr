...
export const DataTablePagination = <TData,>({ table, className }: DataTablePaginationProps<TData>) => {
  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-between">
        <div className="flex w-[130px] items-center justify-center text-sm font-medium @2xl/content:hidden">
      ...
      <div className="flex items-center sm:space-x-6 lg:space-x-8">
        <div className="flex w-[130px] items-center justify-center text-sm font-medium @max-3xl/content:hidden">
          {t('table.page')} {currentPage} {t('table.of')} {totalPages}
        </div>
          ...
          {pageNumbers.map((pageNumber, index) => (
            <div key={`${pageNumber}-${index}`} className="flex items-center">
              {pageNumber === '...' ? (
                ...
                >
                  <span className="sr-only">{t('table.goToPage', { page: pageNumber })}</span>
                  {pageNumber}
                </Button>
              )}
            </div>
